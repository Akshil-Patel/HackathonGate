...
const teamRegistry = {
    ...
    TEAM_138: { name: 'BYTE BOSTERS', leader: 'SHIVANAND DALVI' },
    TEAM_139: { name: 'Cognivis', leader: '' },
    TEAM_140: { name: 'CODE BYTES', leader: 'NOORJAHAN NADAF' },
    TEAM_141: { name: 'Dev X', leader: 'CHAITRA MUKHESH YALAMALLI' },
    TEAM_142: { name: 'Team Kaai', leader: 'ISMAIL M MULLA' },
    TEAM_143: { name: 'TechTwins', leader: 'RAGHAVENDRASING BALAJISING HAJERI' },
    TEAM_144: { name: 'Segmentation Squad', leader: 'SHRIDHAR HEGDE' },
    TEAM_145: { name: 'SVAN', leader: '' },
    TEAM_146: { name: 'ECONEXUS', leader: 'KALI KUMARI' },
    TEAM_147: { name: 'MAVRIX', leader: '' },
    TEAM_148: { name: 'DEBUGGERS', leader: 'SHREYA N NADAKARNI' },
    TEAM_149: { name: 'QUAD SQUAD', leader: 'SAIRAJ' },
    TEAM_150: { name: 'Innovative_x', leader: 'DEEPA C SHET' },
    TEAM_151: { name: 'Code Commanders', leader: 'VINYA S K' },
    TEAM_152: { name: 'WEB PIN ALPHA', leader: 'FAIZAN PINITOD' },
    TEAM_153: { name: 'Deep Learners', leader: 'N ANKITHA' },
    TEAM_154: { name: 'Artemis', leader: 'SACHIN BHARGAV' },
    TEAM_155: { name: 'Runtime Terror', leader: 'KOUSARJAHA NADAF' },
    TEAM_156: { name: 'ByteX', leader: 'RAMYA' },
    TEAM_157: { name: 'VEDIC AI', leader: 'GNANASHRI J' },
};
