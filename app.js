...
const teamRegistry = {
    ...
    TEAM_139: { name: 'AGADI RULES', leader: 'VASHON JAMES' },
    TEAM_140: { name: 'BYATE CODERS', leader: 'BIBIHAJRA M' },
    TEAM_141: { name: 'BYTEBUSTERS', leader: 'SHIVANAND DALVI' },
    TEAM_142: { name: 'BYTEX', leader: 'RAMYA' },
    TEAM_143: { name: 'CODE COMMANDERS', leader: 'VINYA S K' },
    TEAM_144: { name: 'CODEBYTES', leader: 'NOORJAHAN NADAF' },
    TEAM_145: { name: 'CORETECH', leader: 'GULNAAZ ARA MAKANDAR MAKANDAR' },
    TEAM_146: { name: 'CRACKERS', leader: 'SUMIT RAIKAR' },
    TEAM_147: { name: 'DEBUGGERS', leader: 'SHREYA N NADAKARNI' },
    TEAM_148: { name: 'DEEPLEARNERS', leader: 'N ANKITHA' },
    TEAM_149: { name: 'DEVX', leader: 'CHAITRA MUKHESH YALAMALLI' },
    TEAM_150: { name: 'Eigen Ai', leader: 'karan navalagand' },
    TEAM_151: { name: 'MAVERICKS', leader: 'VINAYAK MAHANTESH HUGAR' },
    TEAM_152: { name: 'NIKHIL KUMAR A H', leader: 'NIKHIL KUMAR A H' },
    TEAM_153: { name: 'QUAD SQUAD', leader: 'SAIRAJ' },
    TEAM_154: { name: 'Tech Builders', leader: 'Sonal Hugar' },
    TEAM_155: { name: 'SEGMENTATION SQUAD', leader: 'SHRIDHAR HEGDE' },
    TEAM_156: { name: 'SUHASH G', leader: 'SUHASH G' },
    TEAM_157: { name: 'TEAM AGMR STARS', leader: 'SHASHANK DODDAMANI' },
    TEAM_158: { name: 'TEAM ARTEMIS', leader: 'SACHIN BHARGAV' },
    TEAM_159: { name: 'TEAN KAAI', leader: 'ISMAIL M MULLA' },
    TEAM_160: { name: 'TECH TWINS', leader: 'RAGHAVENDRASING BALAJISING HAJERI' },
    TEAM_161: { name: 'VEDIC AI', leader: 'GNANASHRI J' },
    TEAM_162: { name: 'WEB PIN ALPHA', leader: 'FAIZAN PINITOD' },
};
